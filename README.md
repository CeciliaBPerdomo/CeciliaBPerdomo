...
| Lenguajes | Front-end | Frameworks de Estilo | Backend, DB & Servicios | 🧪 Testing | 🚀 Deploy & Hosting | 🔌 Integraciones & CMS |
|-----------|-----------|----------------------|--------------------------|------------|---------------------|-------------------------|
